    ...
    <div className="min-h-screen bg-background transition-colors duration-300 font-outfit">
      ...
      <div className="bg-white/80 dark:bg-black/90 text-foreground dark:text-heading-gold px-6 py-8 sticky top-0 z-30 shadow-xl backdrop-blur-2xl border-b border-border/50 dark:border-neutral-900 transition-all duration-500 rounded-b-[40px]">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-black tracking-tighter uppercase italic">Trace Audit</h1>
            <p className="text-muted-foreground dark:text-neutral-500 text-[10px] font-black uppercase tracking-[0.2em] opacity-80 transition-colors">Digital Identity Verified</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-6 py-10">
        <div className="bg-black dark:bg-neutral-950 rounded-[50px] shadow-[0_40px_80px_rgba(0,0,0,0.4)] p-12 text-center text-white relative overflow-hidden group border border-white/5 dark:border-neutral-900">
          ...
          <h2 className="text-5xl font-black mb-3 tracking-tighter relative z-10 uppercase italic transition-colors dark:text-white">Protocol Valid</h2>
          <p className="text-emerald-100 dark:text-neutral-400 text-sm mb-8 font-bold relative z-10 opacity-90 italic uppercase tracking-[0.2em]">
            Integrity check complete.
          </p>
          <div className="flex justify-center relative z-10">
            <Badge className="bg-heading-gold text-black text-[10px] font-black px-8 py-3 rounded-2xl uppercase tracking-[0.3em] shadow-[0_20px_40px_rgba(0,0,0,0.4)] border-none italic transition-all hover:scale-105">
      ...
      <div className="px-6 pb-8">
        <div className="bg-card dark:bg-neutral-950 rounded-[45px] shadow-sm border border-border/50 dark:border-neutral-900 overflow-hidden transition-all duration-500">
          ...
          <div className="bg-accent/30 dark:bg-neutral-900 px-10 py-10 border-b border-border/30 dark:border-neutral-900 flex items-center justify-between">
            <div>
              <h3 className="font-black text-foreground dark:text-white text-3xl tracking-tighter uppercase italic mb-2 transition-colors">{product.name}</h3>
              <p className="text-muted-foreground dark:text-neutral-500 text-[10px] font-black uppercase tracking-[0.3em] opacity-70 italic">{product.category}</p>
            </div>
          ...
          <div className="p-10 space-y-10">
            <div className="flex items-start gap-6 animate-in slide-in-from-right duration-500 delay-100">
              ...
              <div className="flex-1">
                <p className="font-black text-foreground dark:text-heading-gold text-[10px] uppercase tracking-[0.3em] mb-2 opacity-60 italic">Audit Signal ID</p>
            ...
            <div className="flex items-start gap-6 animate-in slide-in-from-right duration-500 delay-200">
              ...
              <div className="flex-1">
                <p className="font-black text-foreground dark:text-heading-gold text-[10px] uppercase tracking-[0.3em] mb-2 opacity-60 italic">Node Location</p>
                <p className="text-foreground dark:text-white text-base font-black tracking-tighter transition-colors uppercase italic">{batch.manufacturingLocation}</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-8">
               <div className="flex items-start gap-6 animate-in slide-in-from-right duration-500 delay-300">
                ...
                <div className="flex-1">
                  <p className="font-black text-foreground dark:text-heading-gold text-[9px] uppercase tracking-[0.3em] mb-2 opacity-60 italic">Genesis</p>
               ...
               <div className="flex items-start gap-6 animate-in slide-in-from-right duration-500 delay-400">
                ...
                <div className="flex-1">
                  <p className="font-black text-foreground dark:text-heading-gold text-[9px] uppercase tracking-[0.3em] mb-2 opacity-60 italic">Expiry</p>
                  <p className="text-foreground dark:text-neutral-300 text-xs font-black tracking-widest transition-colors">
            ...
            <div className="flex items-start gap-6 animate-in slide-in-from-right duration-500 delay-500">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-2">
                   <p className="font-black text-foreground dark:text-heading-gold text-[10px] uppercase tracking-[0.3em] opacity-60 italic">Protocol Integrity</p>
                   <Sparkles className="w-3.5 h-3.5 text-yellow-500 animate-pulse" />
                </div>
                <p className="text-foreground dark:text-white text-base font-black tracking-tighter transition-colors uppercase italic mb-4">{batch.halalCertification}</p>
                <div className="bg-emerald-50/50 dark:bg-neutral-900 p-6 rounded-[30px] border border-emerald-100 dark:border-neutral-800 transition-colors">
                   <p className="text-[10px] text-emerald-800 dark:text-neutral-500 font-bold leading-relaxed italic uppercase tracking-[0.2em]">
        ...
        <div className="bg-card dark:bg-neutral-950 rounded-[45px] shadow-sm border border-border/50 dark:border-neutral-900 p-10 transition-colors">
          <div className="flex items-center justify-between mb-8 px-2">
            <div className="flex items-center gap-5">
               ...
               <div>
                  <h3 className="font-black text-foreground dark:text-white text-xl tracking-tighter uppercase italic transition-colors">Molecular Deck</h3>
                  <p className="text-[10px] text-muted-foreground dark:text-neutral-500 font-black uppercase tracking-widest opacity-60">Verified Composites</p>
               </div>
            </div>
            <div className="text-[9px] font-black text-emerald-600 dark:text-heading-gold uppercase tracking-[0.3em] flex items-center gap-2 bg-emerald-50 dark:bg-heading-gold/10 px-4 py-2 rounded-xl transition-colors italic">
      ...
      <div className="px-6 pb-12 space-y-5">
        ...
        <Button
          ...
          variant="outline"
          className="w-full h-18 border-2 border-border/50 dark:border-neutral-800 text-foreground dark:text-neutral-400 hover:bg-accent dark:hover:bg-neutral-900/50 font-black rounded-[35px] transition-all active:scale-95 flex items-center justify-center gap-4 uppercase tracking-[0.3em] italic text-sm"
        >
      ...
      <div className="pb-16 text-center">
         <button className="text-[9px] font-black text-muted-foreground dark:text-neutral-700 uppercase tracking-[0.4em] flex items-center gap-3 mx-auto opacity-60 hover:opacity-100 transition-all hover:text-emerald-600 dark:hover:text-heading-gold italic">
            Audit Proof Blockchain Ledger
